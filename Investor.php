...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active ml-3">
                    <a class="nav-link" href="#">Home | Investor <span class="sr-only">(current)</span></a>
                </li>
            ...
            <span class="navbar-text">
                ...
                <li class="nav-item mr-3 ">
                    <a class="nav-link" href="./investor/sugardistribution.php">Sugar Distribution</a>
                </li>

                <li class="nav-item mr-4 active">
                    <a class="nav-link" href="./investor/query.php">Query</a>
                </li>
    ...
    <form method="POST" action="investorupload.php" enctype="multipart/form-data">
        ...
        <div class="input-group mb-1 p-2">
            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="validationTooltip01" name="cardno" required>
                    <div class="valid-tooltip">
                        Looks good!
                    </div>
                </div>
            ...
            <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroupFileAddon01">Investor ID </span>
            </div>
