...
<?php
         ...
         if (isset($_POST['queryl']) && !empty($_POST['query'])) {
            ...
            $queryd=$_POST['query'];
            $id=$_POST['farmerid'];
            $sql2 = "UPDATE image SET query='$queryd' WHERE farmerid=$id";
            if(mysqli_query($conn, $sql2)){
                echo "<div class='alert alert-success' role='alert'>
                Query Recorded , We will Help You out Soon ! Refresh Page to Check
    ...
    <div class="container mt-2">
        <table class="table table-bordered">
            ...
            ?>
                <tr>
                <td> <?php $d=$row['farmerid']?> 
                    <?php echo $row['farmerid']??''; ?></td>
                    <td><?php echo $row['aadhar']; ?></td>
                    <td><?php echo $row['address']; ?></td>
                    <td><?php echo $row['query']; ?></td>
                    <td><?php echo $row['querysolve']; ?></td>
                    <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $d ?>" >Query</button></td>
                </tr>
    ...
    <!--quey model-->
        ...
        <div class="modal-dialog">
            ...
            <form class="form-signin" role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);
                        ...
                        <input type="text"  hidden  id="mad1" name="farmerid">
