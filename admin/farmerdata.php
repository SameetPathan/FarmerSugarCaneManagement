   ...
   <span aria-hidden='true'>&times;</span>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <span class="navbar-text">
                ...
                <li class="nav-item  active">
                    <a class="nav-link"><button type="button" data-toggle="modal" data-target="#exampleModal1"  class="btn btn-outline-success">Date Wise</button></a>
                </li>
                    <li class="nav-item">
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-success" id="exampleModalLabel">Farmers Information Date Wise</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="Farmersort.php" method="post">

                        <h4 class="form-signin-heading"></h4>

                        <input type="text" hidden id="mad" name="id">
                       
                        <label for="harvesting">From Date</label>
                        <input type="date" class="form-control" name="from" placeholder="From Date" required autofocus></br>
                        <label for="production">To Date</label>
                        <input type="date" class="form-control" name="to" placeholder="To Date" required autofocus></br>
                     
                        <button class="btn btn-lg btn-primary btn-block mt-2" type="submit">Check</button>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
